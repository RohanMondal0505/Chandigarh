...
<body>
    <div class="main-container">
        ...
        <main>
            <div class="heading">
                <h1>Chandigarh <p>City in India</p>
                </h1>
            </div>
            ...
            <div class="row1">
                <p class="cap">
                    ...
                    Annual Rainfall (2017) 974 mm
                    Monsoon July-September
                    Temperature
                    Winter Min. (Nov 2017 to Feb 2018) 7 0C - 110 C

                    Lowest Tem (Jan 2018) 30C

                    Summer Max. (Apri 2017 to July 2017) 350C - 39 0C

                    Highest Temp (June 17) 450C
                    ...
                    Decennial Population Growth (2011) 17.19%
                    Literacy Rate 86.0%
                </p>
                <span class="sHeading">Geology</span>
                <p class="cap">
            ...
            <div class="row2">
                <div class="row2-1">
                    <div class="row2-11">
                        <p>
                            <span class="sHeading">Climate</span>

                            <p class="cap">Chandigarh falls under Koeppen's CWG category i.e. it has cold dry winter, hot summer and sub tropical monsoon. Evaporation usually exceeds precipitation and the weather is generally dry.</p>
                    ...
                    <div class="row2-12">
                        <h1>The Master Plan of Chandigarh</h1>
                        <p class="cap">
                ...
                <div class="row2-2">
                    <img src="./images/about_lake.gif">
                </div>
            </div>

            <div class="row3">
                <div class="row3-1">
                    <img src="./images/about_plan.jpg">
                    <img src="./images/az.jpg">
                </div>
                <div class="row3-2">
                    <h1>Park Areas</h1>
                    <p class="cap">
